...
- **Common skill (Architecture v1.9):** available to every SearchFit base role — Strategist, Content SEO, Technical SEO, On-Page, Structured Data, SEO QA
- **Not gated** — any of those roles may trigger and approve; no single role gatekeeps
- **Coverage P4:** Shared — all roles
...
- Forced model for this skill remains Gemini 2.5 Pro regardless of who triggers it
